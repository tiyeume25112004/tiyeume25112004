...
🐍 My go-to programming language is Python and Javascript, and my favourite framework is Flask and ExpressJS. I can also do some C++ and PHP.

🖤 Fun fact: Im alone, need a cute girlfriend, just anime girls UwU
Bạn không thể chỉ có ước, hãy làm nó bằng hành động, con chóa ak
